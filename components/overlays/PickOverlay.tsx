...
export function PickOverlay({ betData: _betData }: PickOverlayProps) {
  return (
    <View style={styles.container}>
      <View style={styles.overlayContent}>
        <Text style={styles.overlayText}>🎯 Pick</Text>
        <Text style={styles.overlayHint}>Bet details will appear here</Text>
